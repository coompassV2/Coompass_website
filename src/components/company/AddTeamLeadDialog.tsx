  ...
  const handleAddTeamLead = () => {
    if (!selectedEmployee) {
      toast({
        ...
        description: "Please select an employee to add as team lead.",
        variant: "destructive"
      });
      return;
    }
    ...
    toast({
      ...
      description: `${selectedEmployee.name} has been added as a team lead.`
    });
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleCancel}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>{t('Add Team Lead')}</DialogTitle>
          <DialogDescription>
            {t('Select an employee to add as a team lead')}
          </DialogDescription>
        </DialogHeader>
