...
import { BrisaCompanyGrid } from "./BrisaCompanyGrid";
...
interface BrisaCompanySelectorProps {
  companies: Company[];
...
export function BrisaCompanySelector({ 
  companies, 
  selectedCompany, 
  selectedAccessType,
  isLoading, 
      ...
      <div className="w-full max-w-md">
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <Button
              onClick={() => onAccessTypeSelect("executive")}
              variant={selectedAccessType === "executive" ? "default" : "outline"}
              className={`
                py-3 rounded-lg transition-colors font-medium text-sm
                ${selectedAccessType === "executive" 
                  ? "bg-teal-500 hover:bg-teal-600 text-white border-teal-500" 
                  : "bg-gray-800 hover:bg-gray-700 text-gray-300 border-gray-600"
                }
              `}
