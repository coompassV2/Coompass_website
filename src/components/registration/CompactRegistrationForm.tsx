...
export function CompactRegistrationForm({ onSubmit, personaType }: CompactRegistrationFormProps) {
  ...
  return (
    <div className="max-w-5xl mx-auto w-full">
      <Form {...form}>
        <form
          onSubmit={form.handleSubmit(() => setCurrentStep(3))}
          className="space-y-6"
        >
          {/* Main registration container: horizontal on md+ screens */}
          <div className="flex flex-col md:flex-row gap-6">
            {/* Account Information */}
            <div className="md:w-1/2">
              <div className="bg-black/30 backdrop-blur-lg border border-white/10 p-4 space-y-3 rounded-xl h-full flex flex-col">
                        ...
                        <FormControl>
                          <div className="relative">
                            ...
                            <Input 
                              ...
                              className="bg-black/30 border-white/10 pl-10 text-white h-9" 
                              {...field} 
                            />
                          </div>
                        </FormControl>
